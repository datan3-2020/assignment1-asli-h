...
This result shows that 48% supported Remain and 40% supported Leave. The
real result for Remain was 48%, while Leave was nearly 52%. Remain is
almost the same, but not Leave. According to this, Remain should have
higher support, but it does not in the real referendum. This is because
this is a small sample of 22957 people, with removed observations and
10% missing data.
...
We can see that that support for Remain consistently decreases as the
age increases. We can also see that men in the same age groups are much
less likely to support Remain than women.
